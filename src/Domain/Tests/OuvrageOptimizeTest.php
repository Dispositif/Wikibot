    ...
    public function provideSomeParam()
    {
        return [
            ...
            [
                ...
                '{{Ouvrage|titre=|éditeur=|année=|pages totales=|isbn=|lire en ligne=https://books.google.fr/books?id=3KNeP3Hm0TAC&pg=PA184&q=apolline+de+Gourlet&dq=apolline+de+Gourlet}}',
            ],
            [
                [
                    'commentaire' => 'bla',
